...
if __name__ == '__main__':
    ...
    with pool:
        ...
        for sm in range(len(semtypes)):
            ...
            #   ds)
            pool.map(partial(exp6.estimate_once_dagma, 
              graph_type="BP", seed=5052, sem_type=semtypes[sm], lambda1=0, BB=500, noise="normal"),
              ds)
            pool.map(partial(exp6.estimate_once_dagma, 
              graph_type="BP", seed=5053, sem_type=semtypes[sm], lambda1=0, BB=500, noise="uni"), 
              ds)
